...
// import InfluencersListHook from "@/src/routes/Admin/Hooks/influencers-list-hook";
// import Spinner from "@/src/app/component/custom-component/spinner";

// export default function ApprovedInfluencers() {
//   const { campaignId } = useParams<{ campaignId: string }>();
//   const { clearAddedInfluencers } = AddedInfluencersStore();
//   const { data, isLoading, isError } = InfluencersListHook(campaignId ?? "");

//   const router = useRouter();
//   if (isLoading) {
//     return (
//       <div className="min-h-screen bg-gradient-to-r from-[#0c0c22] via-[#3c69bb] to-[#1a1a3f] flex items-center justify-center">
//         <div className="bg-white/10 backdrop-blur rounded-2xl border border-white/20 p-4 sm:p-6 shadow-sm flex justify-center items-center w-30 h-30">
//           <Spinner size="lg" />
//         </div>
//       </div>
//     );
...
//               Your selected influencers for this campaigns
//             </p>
//           </div>
//         </div>
//       </div>
...
//                       Selected Influencers ({data?.campaign?.name})
//                     </h2>
