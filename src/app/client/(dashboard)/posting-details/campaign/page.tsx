...
function ClientCampaignPostingDetailsContent() {
  ...
  const details = useMemo(
    () => rawDetails.filter((d) => d.campaign_id === campaignId),
    [rawDetails, campaignId],
  );
    ...
    return (
      <div className="space-y-6">
        <PageHeader
          ...
          description="Select a campaign from Posting Details to view schedules, captions, and tags."
    ...
    <>
      ...
      <div className="pb-4">
        <Button
          variant="ghost"
          asChild
          className="mb-4 -ml-2 text-foreground/70 hover:text-foreground"
        >
          <Link href="/client/posting-details">← Back to campaigns</Link>
        </Button>
      </div>
                  ...
                  {isLoading ? (
                    ...
                    filtered.map((detail) => {
                      ...
                      return (
                        <tr
                          key={detail._id}
                          className="transition-colors hover:bg-foreground/2.5"
                        >
                          <td className="px-8 py-4">
                          ...
                          <td className="px-6 py-4">
                            <p
                              className="max-w-[220px] truncate text-sm text-foreground/55"
...
export default function ClientCampaignPostingDetailsPage() {
  return (
    <Suspense
      fallback={
    ...
    >
      <ClientCampaignPostingDetailsContent />
    </Suspense>
  );
}
