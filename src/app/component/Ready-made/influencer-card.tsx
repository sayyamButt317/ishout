// import { ReadyMadeInfluencerResponse, ReadyMadeInfluencersResponse } from "@/src/types/readymadeinfluencers-type";
...
//         {results.results.map((group: ReadyMadeInfluencersResponse, idx: number) => (
//           <section
//             key={`${group.platform}-${group.followers}-${idx}`}
//             className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm"
//           >
//             <div className="flex items-start justify-between gap-4 mb-4">
//               <div>
//                 <h2 className="text-lg font-semibold text-slate-900">
//                   {group.platform} Influencers
//                 </h2>
...
//                   </span>
//                   <span className="inline-flex items-center rounded-full border border-slate-200 bg-white px-2.5 py-1 text-slate-700">
//                     Followers: {group.followers_display}
//                   </span>
//                   <span className="inline-flex items-center rounded-full border border-slate-200 bg-white px-2.5 py-1 text-slate-700">
//                     Total: {group.count}
//                   </span>
