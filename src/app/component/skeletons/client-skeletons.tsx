...
export function ClientDashboardHomeSkeleton() {
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="relative overflow-hidden rounded-2xl border border-white/6 bg-section-overlays p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-3">
            <Skeleton className="h-10 w-10 shrink-0 rounded-lg bg-white/8" />
      ...
      <Skeleton className="h-40 w-full max-w-2xl rounded-2xl border border-white/10 bg-white/3" />
    </div>
  );
}
    ...
    <div className="w-full space-y-6 animate-in fade-in duration-300">
      <div className="relative overflow-hidden rounded-2xl border border-white/6 bg-section-overlays p-6">
        <div className="flex items-start gap-3">
          <Skeleton className="h-10 w-10 shrink-0 rounded-lg bg-white/8" />
          <div className="space-y-2">
            <Skeleton className="h-7 w-[min(100%,28rem)] bg-white/8" />
          ...
          >
            <div className="flex flex-col gap-6 md:flex-row md:items-center">
              <div className="flex-1 space-y-4">
                ...
                <Skeleton className="h-8 w-56 bg-white/8" />
                <Skeleton className="h-4 w-full max-w-md bg-white/5" />
                <Skeleton className="h-10 w-36 rounded-full bg-white/6" />
              </div>
              <Skeleton className="h-48 flex-1 rounded-2xl bg-white/5 md:max-w-sm" />
            </div>
          </div>
        ))}
      </div>
    ...
    <div className="space-y-6 animate-in fade-in duration-300 font-sans">
      <div className="relative overflow-hidden rounded-2xl border border-white/6 bg-section-overlays p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <Skeleton className="h-10 w-full max-w-64 rounded-lg bg-white/6" />
        </div>
      </div>
      <div className="flex flex-wrap gap-2">
        {Array.from({ length: 7 }).map((_, i) => (
          <Skeleton key={i} className="h-9 w-24 rounded-full bg-white/6" />
        ))}
      </div>
      <div className="flex flex-wrap items-center gap-3">
        <Skeleton className="h-9 w-28 rounded-lg bg-white/5" />
        <Skeleton className="h-9 w-28 rounded-lg bg-white/5" />
        <Skeleton className="ml-auto h-9 w-32 rounded-lg bg-white/5" />
      </div>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: cards }).map((_, i) => (
          ...
          >
            <Skeleton className="aspect-video w-full rounded-none bg-white/6" />
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid gap-6 lg:grid-cols-[auto_1fr] lg:items-start">
        <div className="flex flex-col items-center gap-3 rounded-xl border border-white/5 bg-foreground/5 p-6">
          <Skeleton className="h-24 w-24 rounded-full bg-white/8" />
            ...
            >
              ...
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="space-y-2">
                  ...
                  <Skeleton className="h-11 w-full rounded-xl bg-white/6" />
                </div>
              ))}
              <div className="flex justify-end gap-2 pt-2">
                <Skeleton className="h-9 w-24 rounded-xl bg-white/6" />
                <Skeleton className="h-9 w-28 rounded-xl bg-white/8" />
              </div>
            </div>
          ))}
        </div>
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-4 rounded-2xl border border-white/10 bg-black/25 p-6">
          ...
          <Skeleton className="h-11 w-full rounded-xl bg-white/8 sm:max-w-xs" />
        </div>
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="relative overflow-hidden rounded-2xl border border-white/6 bg-section-overlays p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <Skeleton className="h-10 w-full sm:w-72 rounded-lg bg-white/6" />
            <Skeleton className="h-10 w-36 rounded-lg bg-white/6" />
          </div>
        </div>
      </div>
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {Array.from({ length: items }).map((_, i) => (
          <div
            key={i}
            className="flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#0f0f12]"
          >
            <Skeleton className="h-40 w-full bg-white/6" />
            <div className="space-y-3 p-4">
              <Skeleton className="h-5 w-3/4 bg-white/8" />
              <Skeleton className="h-3 w-full bg-white/5" />
              <Skeleton className="h-3 w-5/6 bg-white/5" />
              <div className="flex gap-2 pt-2">
                <Skeleton className="h-9 flex-1 rounded-lg bg-white/6" />
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
        {Array.from({ length: cards }).map((_, i) => (
          ...
          >
            <Skeleton className="aspect-video w-full rounded-xl bg-white/6" />
...
export function ClientPlaceholderPageSkeleton() {
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <Skeleton className="h-32 w-full rounded-2xl border border-white/10 bg-white/3" />
    </div>
  );
}
