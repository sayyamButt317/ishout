...
type FeedbackGuidelinesTabProps = {
  briefId: string;
};
  ...
  return (
    <div className="space-y-2">
      {items.map((item, idx) => (
        ...
        >
          <span className="mr-2 text-primaryButton">•</span>
          {item}
        </div>
      ))}
    </div>
...
export default function FeedbackGuidelinesTab({ briefId }: FeedbackGuidelinesTabProps) {
    ...
    <div className="min-h-75 flex-1 overflow-y-auto p-3 lg:min-h-0">
      {!briefId ? (
        ...
        <div className="space-y-3">
          <div className="rounded-xl border border-primaryButton/25 bg-linear-to-r from-primaryButton/15 via-primaryButton/5 to-transparent p-4">
            <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-primaryButton/30 bg-primaryButton/10 px-2 py-1 text-[10px] font-semibold uppercase tracking-wider text-primaryButton">
          ...
          <div className="rounded-xl border border-white/10 bg-[#10131A] p-4">
            <h3 className="mb-3 inline-flex items-center gap-2 text-sm font-semibold text-white">
              <ScrollText className="size-4 text-primaryButton" />
              Campaign Overview
            </h3>
          ...
          <div className="rounded-xl border border-white/10 bg-[#10131A] p-4">
            <h3 className="mb-3 inline-flex items-center gap-2 text-sm font-semibold text-white">
              <ClipboardList className="size-4 text-primaryButton" />
          ...
          <div className="rounded-xl border border-white/10 bg-[#10131A] p-4">
            <h3 className="mb-3 inline-flex items-center gap-2 text-sm font-semibold text-white">
              <CalendarClock className="size-4 text-primaryButton" />
              Timeline
            </h3>
