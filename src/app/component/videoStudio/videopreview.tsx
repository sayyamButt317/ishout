import { Maximize2, Settings, Video, Zap } from 'lucide-react'
  ...
  return (
        ...
        <div className="aspect-[9/16] w-full">
          <div className="flex flex-col items-center justify-center gap-4 p-6 text-center">
            <div className="mb-2 flex size-16 items-center justify-center rounded-full bg-[var(--color-primaryButton)]/10">
              <Video className="size-8 text-[var(--color-primaryButton)]" />
            </div>
            <h3 className="text-lg font-bold leading-tight text-white">
              Ready to generate
            </h3>
            <p className="px-4 text-xs text-white/50">
              Configure your assets and style to begin the AI rendering process.
            </p>
    ...
    <div className="space-y-4 border-t border-white/10 p-8">
      <div className="mb-2 flex items-center justify-between text-xs">
        <span className="font-medium text-white/50">Estimated Render Time</span>
        <span className="font-bold text-white">~45 seconds</span>
      </div>
