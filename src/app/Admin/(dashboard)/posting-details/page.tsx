...
import { RefreshCcw, ClipboardList, Search, Trash2 } from 'lucide-react';
import useDeletePostingDetailHook from '@/src/routes/Admin/Hooks/posting/delete-posting-detail-hook';
import type { AdminPostingDetailsListResponse } from '@/src/types/Posting/posting-details-type';
...
export default function PostingDetailsPage() {
  ...
  const postingData = data as AdminPostingDetailsListResponse | undefined;
        ...
        <div className="overflow-hidden rounded-2xl border border-red/5 bg-foreground/5 shadow-2xl shadow-black/40">
          ...
          <div className="flex items-center justify-between border-t border-foreground/5 bg-foreground/5 px-8 py-5">
            <p className="text-xs text-foreground/80">
              ...
              of <span className="font-bold text-foreground">{details.length}</span> rows
              {search.trim() ? (
