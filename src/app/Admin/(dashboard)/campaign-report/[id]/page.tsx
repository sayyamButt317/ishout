...
export default function InfluencerReportHeader() {
  ...
  const { data, isLoading } = CampaignAllInfluencerHook(id);
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {data.influencers.map((inf: Influencer, index: number) => {
          ...
          >
            ...
            <div className="flex-1 p-5 flex flex-col justify-between">
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-3">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                      <div
                        className={`h-full ${getEngagementColor(engRateNumber)} transition-all duration-500`}
                        style={{
                ...
                {/* Extra Meta */}
                <div className="text-[10px] text-white/40 flex flex-row justify-between">
                  <p>
                    Posted:{" "}
